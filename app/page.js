...
export default async function CaseList() {
  ...
  // Totals across every case, so the page answers the system's own question
  ...
  return (
    <>
      ...
      <footer className="provenance">
        All data in this system is synthetic and was generated by the team. No real persons,
        cases, accounts or personal data are represented.
      </footer>
    </>
  );
}
